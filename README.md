...
**interactive data-driven webmaps — [demo](https://maps.demo.zalxon.com)**
...
[build status]: https://github.com/zalxon/maps/actions/workflows/main.yml/badge.svg
[actions]: https://github.com/zalxon/maps/actions/workflows/main.yml
[mit license]: https://badgen.net/badge/license/MIT/blue
[npm version]: https://badgen.net/npm/v/@zalxon/maps

## background

There are many approaches to making web maps, and many different data sources and use cases.

One common case for us at Zalxon is rendering gridded _raster_ data on a map. These data are multi-dimensional, for example, representing multiple time points or variables. We want high performance and flexibility in rendering. We also want to use the same file formats from our analysis.

We're building `@zalxon/maps` to address these needs! We'll be releasing early and often so we can use it ourselves, but it's very much in progress, so expect lots of major version bumps and breaking changes.

Check out the demo ([site](https://maps.demo.zalxon.com), [code](https://github.com/zalxon/maps/tree/main/demo)) which renders monthly temperature and precipitation data, or read on for more info on the library.
...
```jsx
import { Map, Raster } from '@zalxon/maps'
  ...
  return (
    <Map>
      <Raster
        ...
        clim={[-20, 30]}
        source={
          'https://storage.googleapis.com/zalxon/map-tests/processed/temp'
        }
...
<Map>
  <Raster
    ...
    clim={[-20, 30]}
    source={
      'https://storage.googleapis.com/zalxon/map-tests/processed/temp-month'
    }
    variable={'temperature'}
...
Zalxon is a non-profit organization that uses data and science for climate action. We aim to improve the transparency and scientific integrity of climate solutions with open data and tools. Find out more at [zalxon.com](https://zalxon.com/) or get in touch by [opening an issue](https://github.com/zalxon/maps/issues/new) or [sending us an email](mailto:hello@zalxon.com).